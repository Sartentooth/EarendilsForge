  ...
  const pasos = [
    {
      ...
      descripcion:
        "Analizamos tu idea y la convertimos en un modelo 3D optimizado para impresión.",
      icono: (
        <svg
          className="w-8 h-8"
          fill="none"
    ...
    },
    {
      ...
      titulo: "Impresión",
      descripcion:
        "Utilizamos tecnología de vanguardia para materializar tu proyecto con la máxima calidad.",
      icono: (
        <svg
          className="w-8 h-8"
          fill="none"
    ...
    },
    {
      ...
      titulo: "Acabado",
      descripcion:
        "Aplicamos técnicas de post-procesado para lograr el acabado perfecto que imaginaste.",
      icono: (
        <svg
          className="w-8 h-8"
          fill="none"
    ...
    },
    {
      ...
      titulo: "Entrega",
      descripcion:
        "Tu proyecto listo, empacado con cuidado y entregado en tiempo y forma.",
      icono: (
        <svg
          className="w-8 h-8"
          fill="none"
    ...
    <section className="py-20 px-4">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          >
            Desde la idea hasta la realidad, cada proyecto pasa por nuestro
            proceso artesanal que combina creatividad, tecnología y precisión.
          </p>
        </div>
          ...
          {pasos.map((paso, index) => (
            <div key={index} className="relative group">
              ...
              {index < pasos.length - 1 && (
                <div
                  className="hidden lg:block absolute top-16 left-full w-full h-px bg-gradient-to-r from-transparent via-current to-transparent opacity-30 z-0"

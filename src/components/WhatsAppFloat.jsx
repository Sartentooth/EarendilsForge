...
const WhatsAppFloat = ({ phoneNumber = "5491123456789", message = "¡Hola! Me interesa conocer más sobre sus servicios de impresión 3D" }) => {
  ...
  return (
    ...
    >
      {/* Tooltip épico */}
      <div
        className={`absolute bottom-full right-0 mb-3 px-4 py-2 rounded-lg shadow-xl transition-all duration-300 transform ${
      ...
      <button
        ...
        className={`relative w-16 h-16 rounded-full shadow-2xl transition-all duration-300 transform hover:scale-110 hover:-translate-y-1 ${
          isHovered ? 'shadow-green-500/30' : 'shadow-black/30'
        }`}
        style={{
